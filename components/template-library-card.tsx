...
import { LayoutGrid, Eye, Copy, Pin, X } from "lucide-react"
...
interface TemplateLibraryCardProps {
  ...
  isPinned: boolean
  pinnedCount: number
  onView: (template: WritingTemplate) => void
  onCopy: (template: WritingTemplate) => void
  onPin: (template: WritingTemplate) => void
  onUnpin: (template: WritingTemplate) => void
